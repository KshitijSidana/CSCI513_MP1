...
class Simulator:
    ...
    def _clear_all_actors(self):
        ...
        ### This was the block causing the WARNING ###
        # WARNING: attempting to unsubscribe from stream but sensor wasn't listening: Actor 2407 (sensor.other.collision)
        #
    ...
    def _get_actor_polygons(self, filt):
        ...
        for actor in self.world.get_actors().filter(filt):
            ...
            R = np.array([[np.cos(yaw), -np.sin(yaw)], [np.sin(yaw), np.cos(yaw)]])  # type: ignore
